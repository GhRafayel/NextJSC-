...
export const language : TranslationType = {
        ...
        "HomePage": {
            ...
            "motoFirst":"PLANT.DETONATE.",
            "motoSecond":"SURVIVE.",
            "description":"A multiplayer bomb arena where four heroes enter, one survives the blast. Real-time. Cross-platform. No mercy.",
            "sBtn": "Start Playing",
            "cards": [
                {
                    "title": "vs AI",
        ...
        Legal: {
            privacyPolicy: {
                ...
                intro: "Detonate (“the Project”, “we”, “us”) is a real-time multiplayer game built as an educational project for the 42 curriculum (ft_transcendence). This policy explains what data we collect when you use the application, why we collect it, and what choices you have.",
                sections: [
                    {
                        ...
                        items: [
                            ...
                            { label: "Preferences:", text: "chosen language, light/dark theme, avatar, and hero color." },
            ...
            termsOfService: {
                ...
                updated: "Last updated: August 24, 2026",
                intro: "These Terms govern your use of Detonate (“the Project”), a real-time multiplayer game built as an educational project for the 42 curriculum (ft_transcendence). By creating an account or using the app, you agree to these Terms.",
                sections: [
